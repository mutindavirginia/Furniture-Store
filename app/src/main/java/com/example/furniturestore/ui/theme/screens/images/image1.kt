...
@Composable
fun Image1(navController: NavHostController) {
    Column {
        Card(
            modifier = Modifier
                .height(100.dp)
        ...
        Text(
            text = "a black lamp.it is reliable" +
                    " and has a perfect height which can be place in sitting room",
            fontSize = 10.sp,
